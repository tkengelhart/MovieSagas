...
Start by taking inventory of the existing code. Part of the work for setting up sagas has been done for you.

By the time you have completed your work, all `axios` requests should be made from sagas.
